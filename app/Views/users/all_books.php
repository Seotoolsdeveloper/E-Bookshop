	...
	<div class="col-lg-2 col-md-3 col-sm-4">
		<div id="single-book">
			...
			<?php if(session()->get('id') != $book->userId): ?>
				<div id="addto-cart"> <span class="add-to-cart-btn" 
                        data-id="<?= $book->id ?>" 
			...
			<div class="book-text">
				...
				<div id="price">Rs <?= htmlentities($book->price) ?></div>
				<div id="book-details"><a href="<?= base_url(route_to('users.book_view', $book->slug)) ?>">View Details</a></div>
				</div>
		</div>	
	</div>
	<?php endforeach;?>
