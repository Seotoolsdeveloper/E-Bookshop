        ...
        <div class="main-menu">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8">
                    <div class="menu">
                        <ul id="nav">
                            <li><a href="<?= base_url(route_to('home')) ?>">Home</a></li>
                            <li><a href="<?= base_url(route_to('all_books'))?>">Books</a></li>
                            <li><a href="<?= base_url()?>users/all-ebooks">E-books <i class="fas fa-arrow-alt-circle-right"></i></a></li>
                            
                            <!-- #Button trigger modal -->
                            <li><a href = "#" data-bs-toggle="modal" data-target="#exampleModal">Contact Us</a></li>
                            <?php
                            #load contact modal
                            view('temp/contact_modal')  
                            ?>

                            <li><a href = "#" data-bs-toggle="modal" data-target="#aboutModal">About Us</a></li>
                            <?php
                            #Load about model 
                            view('temp/about_modal')
                            ?>
